const useItemEffect = ('../ItemEffects')
//also doesnt work
//import useItemEffect from './ItemEffects'

//objects are hard coded at the top of files
//expect output from test  to match the hardcoded output from
